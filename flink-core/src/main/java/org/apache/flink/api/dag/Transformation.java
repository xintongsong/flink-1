...
public abstract class Transformation<T> {
	...
	public void setParallelism(int parallelism) {
		OperatorResourceParallelismUtils.validateParallelism(parallelism);
		this.parallelism = parallelism;
	}
	...
	public void setMaxParallelism(int maxParallelism) {
		OperatorResourceParallelismUtils.validateMaxParallelism(maxParallelism, UPPER_BOUND_MAX_PARALLELISM);
