...
public class PythonDependencyManager {
	...
	public static final String PYTHON_REQUIREMENTS_FILE = "PYTHON_REQUIREMENTS_FILE";
	public static final String PYTHON_REQUIREMENTS_CACHE = "PYTHON_REQUIREMENTS_CACHE";
