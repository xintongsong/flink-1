...
import org.apache.flink.api.common.operators.util.OperatorResourceParallelismUtils;
...
public class SingleOutputStreamOperator<T> extends DataStream<T> {
	...
	public SingleOutputStreamOperator<T> setParallelism(int parallelism) {
		OperatorResourceParallelismUtils.validateParallelism(parallelism, canBeParallel());
	...
	public SingleOutputStreamOperator<T> setMaxParallelism(int maxParallelism) {
		OperatorResourceParallelismUtils.validateMaxParallelism(maxParallelism, canBeParallel());
	...
	private SingleOutputStreamOperator<T> setResources(ResourceSpec resources) {
		OperatorResourceParallelismUtils.validateResources(resources);
