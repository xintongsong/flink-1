...
public class TaskExecutor extends RpcEndpoint implements TaskExecutorGateway {
	...
	private void setupResultPartitionBookkeeping(
		...
		final Set<ResultPartitionDeploymentDescriptor> partitionsRequiringRelease = filterPartitionsRequiringRelease(producedResultPartitions);
			...
			terminationFuture.thenApplyAsync(
				executionState -> {
					if (executionState != ExecutionState.FINISHED) {
						final Set<ResultPartitionID> partitionIdsRequiringRelease = partitionsRequiringRelease.stream()
							.map(ResultPartitionDeploymentDescriptor::getShuffleDescriptor)
							.map(ShuffleDescriptor::getResultPartitionID)
							.collect(Collectors.toSet());

						partitionTracker.stopTrackingPartitions(partitionIdsRequiringRelease);
					}
	...
	private Set<ResultPartitionDeploymentDescriptor> filterPartitionsRequiringRelease(Collection<ResultPartitionDeploymentDescriptor> producedResultPartitions) {
