...
public class BackPressureStatsTrackerImplTest extends TestLogger {
	...
	public void testGetOperatorBackPressureStats() throws Exception {
		final ExecutionJobVertex jobVertex = mockExecutionJobVertex(JobStatus.RUNNING);
	...
	private BackPressureStatsTracker createBackPressureTracker(
		...
		final BackPressureSampleCoordinator coordinator = mockBackPressureSampleCoordinator(stats);
	...
	private ExecutionJobVertex mockExecutionJobVertex(JobStatus jobStatus) {
	...
	private BackPressureSampleCoordinator mockBackPressureSampleCoordinator(BackPressureStats... stats) {
