...
public class TestingTaskExecutorGatewayBuilder {
	...
	private static final TriConsumer<JobID, Collection<ResultPartitionID>, Collection<ResultPartitionID>> NOOP_RELEASE_PARTITIONS_CONSUMER = (ignoredA, ignoredB, ignoredC) -> {};
	...
	private TriConsumer<JobID, Collection<ResultPartitionID>, Collection<ResultPartitionID>> releaseOrPromotePartitionsConsumer = NOOP_RELEASE_PARTITIONS_CONSUMER;
	...
	public TestingTaskExecutorGatewayBuilder setReleaseOrPromotePartitionsConsumer(TriConsumer<JobID, Collection<ResultPartitionID>, Collection<ResultPartitionID>> releasePartitionsConsumer) {
