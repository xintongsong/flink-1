...
public class BackPressureSampleCoordinatorTest extends TestLogger {
	...
	private ExecutionVertex[] createExecutionVertices(
		...
		return new ExecutionVertex[] {
			mockExecutionVertex(new ExecutionAttemptID(), ExecutionState.RUNNING, CompletionType.SUCCESSFULLY, sampleTimeout),
			mockExecutionVertex(new ExecutionAttemptID(), state, completionType, sampleTimeout)
		};
	}
