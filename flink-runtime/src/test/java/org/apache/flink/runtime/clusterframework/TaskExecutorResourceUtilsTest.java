...
public class TaskExecutorResourceUtilsTest extends TestLogger {
	...
	public void testConfigShuffleMemoryLegacyRangeFraction() {
		...
		Configuration conf = new Configuration();
		conf.setString(NettyShuffleEnvironmentOptions.NETWORK_BUFFERS_MEMORY_MIN, shuffleMin.getMebiBytes() + "m");
		conf.setString(NettyShuffleEnvironmentOptions.NETWORK_BUFFERS_MEMORY_MAX, shuffleMax.getMebiBytes() + "m");
		...
		conf.setFloat(NettyShuffleEnvironmentOptions.NETWORK_BUFFERS_MEMORY_FRACTION, fraction);
	...
	public void testConfigShuffleMemoryLegacyNumOfBuffers() {
		...
		conf.setInteger(NettyShuffleEnvironmentOptions.NETWORK_NUM_BUFFERS, numOfBuffers);
	...
	public void testConfigManagedMemoryLegacySize() {
		...
		Configuration conf = new Configuration();
		conf.setString(TaskManagerOptions.LEGACY_MANAGED_MEMORY_SIZE, managedMemSize.getMebiBytes() + "m");
	...
	@Test
	@SuppressWarnings("deprecation")
	public void testConfigOffHeapManagedMemoryLegacy() {
		Configuration conf = new Configuration();
	...
	@Test
	public void testConfigJvmOverheadFractionFailure() {
		final Configuration conf = new Configuration();
	...
	public void testConfigTotalFlinkMemoryLegacyMB() {
		...
		Configuration conf = new Configuration();
		conf.setInteger(TaskManagerOptions.TASK_MANAGER_HEAP_MEMORY_MB, totalFlinkMemorySize.getMebiBytes());
	...
	public void testConfigTotalFlinkMemoryLegacySize() {
		...
		Configuration conf = new Configuration();
		conf.setString(TaskManagerOptions.TASK_MANAGER_HEAP_MEMORY, totalFlinkMemorySize.getMebiBytes() + "m");
	...
	private void validateFail(final Configuration config) {
		...
		throw new RuntimeException("Configuration did not fail as expected.");
	}
