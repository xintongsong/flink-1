...
public class TaskExecutorResourceUtilsTest extends TestLogger {
	...
	public void testGenerateJvmParameters() {
		...
		assertThat(configs.get("-Xmx"), is(TM_RESOURCE_SPEC.getFrameworkHeapSize().add(TM_RESOURCE_SPEC.getTaskHeapSize()).add(TM_RESOURCE_SPEC.getOnHeapManagedMemorySize())));
		assertThat(configs.get("-Xms"), is(TM_RESOURCE_SPEC.getFrameworkHeapSize().add(TM_RESOURCE_SPEC.getTaskHeapSize()).add(TM_RESOURCE_SPEC.getOnHeapManagedMemorySize())));
		assertThat(configs.get("-XX:MaxDirectMemorySize="), is(TM_RESOURCE_SPEC.getTaskOffHeapSize().add(TM_RESOURCE_SPEC.getShuffleMemSize())));
		assertThat(configs.get("-XX:MaxMetaspaceSize="), is(TM_RESOURCE_SPEC.getJvmMetaspaceSize()));
	}
