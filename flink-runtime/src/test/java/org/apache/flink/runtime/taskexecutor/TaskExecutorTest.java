...
import org.apache.flink.runtime.taskexecutor.slot.TaskSlotAndTableFactory;
...
import static org.apache.flink.runtime.taskexecutor.slot.TaskSlotAndTableFactory.createTaskSlotTableWithDefaultSlots;
...
public class TaskExecutorTest extends TestLogger {
	...
	public void testShouldShutDownTaskManagerServicesInPostStop() throws Exception {
		final TaskSlotTable taskSlotTable = createTaskSlotTableWithDefaultSlots(1);
	...
	private TaskExecutor createTaskExecutorWithJobManagerTable(JobManagerTable jobManagerTable) throws IOException {
		...
		return createTaskExecutor(new TaskManagerServicesBuilder()
			.setTaskSlotTable(createTaskSlotTableWithDefaultSlots(1))
	...
	public void testSlotAcceptance() throws Exception {
		final TaskSlotTable taskSlotTable = createTaskSlotTableWithDefaultSlots(2);
		final JobManagerTable jobManagerTable = new JobManagerTable();
		final JobLeaderService jobLeaderService = new JobLeaderService(taskManagerLocation, RetryingRegistrationConfiguration.defaultConfiguration());
	...
	private static final class TestingTaskSlotTable extends TaskSlotTable {
		...
		private TestingTaskSlotTable(Queue<SlotReport> slotReports) {
			super(TaskSlotAndTableFactory.createDefaultSlotProfiles(1), new TimerService<>(TestingUtils.defaultExecutor(), 10000L));
	...
	private static final class AllocateSlotNotifyingTaskSlotTable extends TaskSlotTable {
		...
		private AllocateSlotNotifyingTaskSlotTable(
			...
			super(TaskSlotAndTableFactory.createDefaultSlotProfiles(1), timerService);
	...
	private static final class ActivateSlotNotifyingTaskSlotTable extends TaskSlotTable {
		...
		private ActivateSlotNotifyingTaskSlotTable(int numberOfDefaultSlots, TimerService<AllocationID> timerService, CountDownLatch slotsToActivate) {
			super(TaskSlotAndTableFactory.createDefaultSlotProfiles(numberOfDefaultSlots), timerService);
