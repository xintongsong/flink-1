...
public class TestingResourceActionsBuilder {
	...
	private FunctionWithException<ResourceProfile, Collection<ResourceProfile>, ResourceManagerException> allocateResourceFunction = (ignored) -> Collections.singleton(ResourceProfile.INFINITE);
	...
	public TestingResourceActionsBuilder setAllocateResourceConsumer(Consumer<ResourceProfile> allocateResourceConsumer) {
		this.allocateResourceFunction = (ResourceProfile resourceProfile) -> {
			...
			return Collections.singleton(ResourceProfile.INFINITE);
		};
		return this;
	}
