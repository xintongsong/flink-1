...
/**
  * Rule only supports that the [[FlinkLogicalCorrelate]] is inner join and contains Python
  * Functions in the condition of its upstream [[FlinkLogicalCalc]].
  *
  ...
  * without python function condition is the upstream of [[FlinkLogicalCorrelate]], but the
  * other [[[FlinkLogicalCalc]] with python function conditions is the downstream
  * of the [[FlinkLogicalCorrelate]].
  */
