...
/**
  * Rule will split the [[FlinkLogicalCalc]] which is the upstream of a [[FlinkLogicalCorrelate]]
  * and contains Python Functions in condition into two [[FlinkLogicalCalc]]s. One [[FlinkLogicalCalc]]
  * without python function condition is the upstream of [[FlinkLogicalCorrelate]], but the other
  * [[[FlinkLogicalCalc]] with python function conditions is the downstream of the [[FlinkLogicalCorrelate]].
