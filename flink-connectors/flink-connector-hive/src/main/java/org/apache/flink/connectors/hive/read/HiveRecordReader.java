...
/**
 * {@link HiveReader} to read files using hadoop {@link RecordReader}.
 */
public class HiveRecordReader implements HiveReader {

	private static final Logger LOG = LoggerFactory.getLogger(HiveRecordReader.class);
