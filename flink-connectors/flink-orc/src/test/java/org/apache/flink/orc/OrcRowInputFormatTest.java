...
public class OrcRowInputFormatTest {
	...
	private static void assertOptions(OrcReader reader, long offset, long length) {
	...
	private static OrcRowReader newReaderWithStripes(
	...
	public void testSplitStripesCustomSplits() throws IOException {
		...
		OrcRowReader reader = newReaderWithStripes(
	...
	public void testSerialization() throws Exception {
		...
		rowOrcInputFormat.addPredicate(
			new OrcReader.Equals("_col1", PredicateLeaf.Type.STRING, "M"));
	...
	public void testNumericBooleanStringPredicates() throws Exception {
		...
		// boolean pred
		rowOrcInputFormat.addPredicate(
			new OrcReader.Equals("boolean1", PredicateLeaf.Type.BOOLEAN, false));
		// boolean pred
		rowOrcInputFormat.addPredicate(
			new OrcReader.LessThan("byte1", PredicateLeaf.Type.LONG, 1));
		// boolean pred
		rowOrcInputFormat.addPredicate(
			new OrcReader.LessThanEquals("short1", PredicateLeaf.Type.LONG, 1024));
		// boolean pred
		rowOrcInputFormat.addPredicate(
			new OrcReader.Between("int1", PredicateLeaf.Type.LONG, -1, 65536));
		// boolean pred
		rowOrcInputFormat.addPredicate(
			new OrcReader.Equals("long1", PredicateLeaf.Type.LONG, 9223372036854775807L));
		// boolean pred
		rowOrcInputFormat.addPredicate(
			new OrcReader.Equals("float1", PredicateLeaf.Type.FLOAT, 1.0));
		// boolean pred
		rowOrcInputFormat.addPredicate(
			new OrcReader.Equals("double1", PredicateLeaf.Type.FLOAT, -15.0));
		// boolean pred
		rowOrcInputFormat.addPredicate(
			new OrcReader.IsNull("string1", PredicateLeaf.Type.STRING));
		// boolean pred
		rowOrcInputFormat.addPredicate(
			new OrcReader.Equals("string1", PredicateLeaf.Type.STRING, "hello"));
	...
	public void testTimePredicates() throws Exception {
		...
		rowOrcInputFormat.addPredicate(
			...
			new OrcReader.Or(
				// timestamp pred
				new OrcReader.Equals("time", PredicateLeaf.Type.TIMESTAMP, Timestamp.valueOf("1900-05-05 12:34:56.100")),
				// date pred
				new OrcReader.Equals("date", PredicateLeaf.Type.DATE, Date.valueOf("1900-12-25")))
			);
	...
	public void testDecimalPredicate() throws Exception {
		...
		rowOrcInputFormat.addPredicate(
			new OrcReader.Not(
				// decimal pred
				new OrcReader.Equals("_col0", PredicateLeaf.Type.DECIMAL, BigDecimal.valueOf(-1000.5))));
	...
	public void testPredicateWithInvalidColumn() throws Exception {
		...
		rowOrcInputFormat.addPredicate(
			new OrcReader.Equals("unknown", PredicateLeaf.Type.LONG, 42));
	}
	...
	public void testReadFileWithFilter() throws IOException {
		...
		rowOrcInputFormat.addPredicate(
			new OrcReader.Or(
				new OrcReader.LessThan("_col0", PredicateLeaf.Type.LONG, 10L),
				new OrcReader.Not(
					new OrcReader.LessThanEquals("_col0", PredicateLeaf.Type.LONG, 1920000L))
			));
		rowOrcInputFormat.addPredicate(
			new OrcReader.Equals("_col1", PredicateLeaf.Type.STRING, "M"));
