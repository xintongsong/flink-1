...
public class OrcColumnarRowInputFormatTest {
	...
	public void testSerialization() throws Exception {
		...
		ColumnarRow row = copy.nextRecord(null);
	...
	public void testReadFileInSplits() throws IOException {
		...
		rowOrcInputFormat = new OrcColumnarRowInputFormat(getPath(TEST_FILE_FLAT), TEST_SCHEMA_FLAT, new Configuration());
	...
	public void testReadFileWithEvolvedSchema() throws IOException {
		...
		ColumnarRow row = rowOrcInputFormat.nextRecord(null);
		assertNotNull(row);
		assertEquals(3, row.getArity());
