...
import org.apache.flink.orc.OrcReader.ColumnPredicate;
import org.apache.flink.orc.OrcReader.Not;
import org.apache.flink.orc.OrcReader.Or;
...
public abstract class OrcInputFormat<T> extends FileInputFormat<T> {
	...
	protected transient OrcReader<T> reader;
