...
import org.apache.flink.kubernetes.kubeclient.fabric8.decorators.ConfigMapDecorator;
import org.apache.flink.kubernetes.kubeclient.fabric8.decorators.Decorator;
import org.apache.flink.kubernetes.kubeclient.fabric8.decorators.FlinkMasterDeploymentDecorator;
import org.apache.flink.kubernetes.kubeclient.fabric8.decorators.InitializerDecorator;
import org.apache.flink.kubernetes.kubeclient.fabric8.decorators.OwnerReferenceDecorator;
import org.apache.flink.kubernetes.kubeclient.fabric8.decorators.ServiceDecorator;
import org.apache.flink.kubernetes.kubeclient.fabric8.decorators.TaskManagerPodDecorator;
...
public class Fabric8FlinkKubeClient implements FlinkKubeClient {
	...
	public Fabric8FlinkKubeClient(Configuration flinkConfig, KubernetesClient client) {
		...
		this.nameSpace = flinkConfig.getString(KubernetesConfigOptions.NAME_SPACE);
