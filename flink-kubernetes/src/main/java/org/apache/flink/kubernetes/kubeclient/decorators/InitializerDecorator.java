 ...
 */
public class InitializerDecorator <R extends HasMetadata, T extends Resource<R>> extends Decorator<R, T> {
	...
	@Override
	protected R doDecorate(R resource, Configuration flinkConfig) {
		...
		meta.setNamespace(flinkConfig.getString(KubernetesConfigOptions.NAME_SPACE));
