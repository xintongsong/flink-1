 ...
 */
public class OwnerReferenceDecorator<R extends HasMetadata, T extends Resource<R>> extends Decorator<R, T> {
	...
	protected R doDecorate(R resource, Configuration flinkConfig) {
		...
		String serviceId = flinkConfig.getString(FlinkService.SERVICE_ID);
