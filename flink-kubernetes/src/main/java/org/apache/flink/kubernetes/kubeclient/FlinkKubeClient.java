...
public interface FlinkKubeClient extends AutoCloseable {
	 ...
	 * A CompletableFuture is returned and could used to wait for service ready.
	 */
	CompletableFuture<FlinkService> createInternalService(String clusterId) throws Exception;

	/**
	 * Create kubernetes service for rest port. This will be by client to interact with flink cluster.
	 */
