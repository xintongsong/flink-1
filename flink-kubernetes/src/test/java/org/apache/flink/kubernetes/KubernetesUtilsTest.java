...
public class KubernetesUtilsTest extends TestLogger {
	...
	public void testGetJobManagerShellCommand() {
		...
		assertEquals(
			...
			KubernetesUtils
				.getJobManagerStartCommand(cfg, jobManagerMem, confDirInPod, logDirInPod,
					false, false, this.getClass().getName()));
		...
		assertEquals(
			...
			KubernetesUtils
				.getJobManagerStartCommand(cfg, jobManagerMem, confDirInPod, logDirInPod,
					true, false, this.getClass().getName()));
		...
		assertEquals(
			...
			KubernetesUtils
				.getJobManagerStartCommand(cfg, jobManagerMem, confDirInPod, logDirInPod,
					false, true, this.getClass().getName()));
		...
		assertEquals(
			...
			KubernetesUtils
				.getJobManagerStartCommand(cfg, jobManagerMem, confDirInPod, logDirInPod,
					true, true, this.getClass().getName()));
		...
		cfg.setString(KubernetesConfigOptions.CONTAINER_START_COMMAND_TEMPLATE,
			"%java% 1 %classpath% 2 %jvmmem% %jvmopts% %logging% %class% %redirects%");
		assertEquals(
