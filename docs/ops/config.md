...
- `fs.input.ignore-file-not-found-exception`: Specifies if there was a bad file as stream and user removed it, whether Flink throws FileNotFoundException or ignore the exception. (DEFAULT: false)
