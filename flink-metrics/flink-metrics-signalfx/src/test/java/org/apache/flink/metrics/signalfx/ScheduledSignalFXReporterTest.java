 ...
 */
public class ScheduledSignalFXReporterTest {
	...
	public void testAddingMetrics() throws Exception {
		...
		com.codahale.metrics.Meter signalFXMeter = new com.codahale.metrics.Meter();
		SignalFXMeterWrapper meterWrapper = new SignalFXMeterWrapper(signalFXMeter);
		...
		assertTrue("Reporter should be of type ScheduledSignalFXReporter", metricReporter instanceof ScheduledSignalFXReporter);

		TestingScheduledSignalFXReporter reporter = (TestingScheduledSignalFXReporter) metricReporter;
