...
/**
 * SignalFX histogram statistics implementation returned by {@link SignalFXHistogramWrapper}.
 * The statistics class wraps a {@link Snapshot} instance and forwards the method calls accordingly.
 */
class SignalFXHistogramStatistics extends HistogramStatistics {

	private final Snapshot snapshot;

	SignalFXHistogramStatistics(Snapshot snapshot) {
